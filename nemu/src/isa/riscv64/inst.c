...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // 求余数字(不保证实现正确)
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, if(SEXT(src2,32) == 0) R(dest) = SEXT(src1,32); else R(dest) = SEXT(SEXT(src1,32) % SEXT(src2,32),32));
  //逻辑运算
  ...
  INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu   , I, R(dest) = (src1 < src2));
